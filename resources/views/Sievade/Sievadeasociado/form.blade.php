                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_cat_organizacion) ? 'Modificar' : 'Agregar ' }}  Comportamiento asociado "
                            route="{{ route('Sievadeasociado.list') }}" />

                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('Sievadeasociado.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
