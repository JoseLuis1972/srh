                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_act_mn) ? 'Modificar' : 'Agregar ' }}  Actuacion dentro del marco Normativo"
                            route="{{ route('Sievademn.list') }}" />

                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('Sievademn.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
