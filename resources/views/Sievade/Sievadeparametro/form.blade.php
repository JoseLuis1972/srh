                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_val_parametro) ? 'Modificar' : 'Agregar ' }} Valor del parametro alcanzado "
                            route="{{ route('Sievadeparametro.list') }}" />

                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('Sievadeparametro.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
