        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <x-template-tittle.tittle-header tittle="Catalogo de Sievade" caption="Criterio y principios " />
                    </div>
                </div>
            </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($sievade->id_crit_princ) ? 'Modificar' : 'Agregar ' }} Criterio y principios "
                            route="{{ route('Sievadecriterio.list') }}" />

                        <br>
                        <form action="{{ route('Sievadecriterio.edit', $sievade->id_crit_princ) }}" method="POST" id="myForm">
                            @csrf
