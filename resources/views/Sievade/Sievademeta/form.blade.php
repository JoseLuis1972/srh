                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_cat_organizacion) ? 'Modificar' : 'Agregar ' }}  Tipo de meta individual "
                            route="{{ route('Sievademeta.list') }}" />

                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('Sievademeta.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
