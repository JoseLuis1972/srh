                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h5 class="font-weight-normal mb-0">Tipo de meta individual</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div>
                                ...
                                @if($letterAdminMatch)
                                    <p class="card-description">
                                        ...
                                        <a href="{{ route('Sievademeta.create') }}" class="text-danger" style="margin-left: 10px;">
...
<div id="deleteModal" class="modal">
    ...
    <!-- CODE SCRIPT-->
    <script src="{{ asset('assets/js/app/Sievade/Sievademeta/table.js') }}"></script>
</x-template-app.app-layout>
