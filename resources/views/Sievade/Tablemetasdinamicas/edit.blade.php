        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <x-template-tittle.tittle-header tittle="Catalogo de Sievade" caption="Metas Individuales " />
                    </div>
                </div>
            </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_metas_ind) ? 'Modificar' : 'Agregar ' }} Cursos"
                            route="{{ route('SievadeTablemetasdinamicas.list') }}" />
                            <br>
                            <div class="row">
                            ...
                            grid="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" />
                             ...
                             <x-template-button.button-form-footer routeBack="{{ route('SievadeTablemetasdinamicas.list') }}" />
                         </form>
                         </div>
                     </div>
                 </div>
         ...
         <script src="{{ asset('assets/js/app/SievadeTablemetasdinamicas/validate.js') }}"></script>
     </x-template-app.app-layout>
