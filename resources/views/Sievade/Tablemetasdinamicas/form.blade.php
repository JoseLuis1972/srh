                         ...
                         @csrf
                            ...
                            <div class="row">
                               ...
                               <x-template-form.template-form-select-required :selectValue=" $selectMetaI"
                                 :selectEdit=" $selectMetaIEdit" name="id_meta_individual" tittle="Tipo de Meta Individual"
                                 grid="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" />
                             </div>
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                               <x-template-form.template-form-select-required :selectValue=" $selecalineacion"
                                  :selectEdit=" $selecalineacionEdit" name="id_val_parametro" tittle="Valor del parámetro  alcanzado"
                                  grid="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" />

                               <x-template-form.template-form-input-required label="Unidad de Medida" type="text"
                                  name="unidad_medica" placeholder="UNIDAD DE MEDIDA"
                                  grid="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" autocomplete=""
                                  value="{{optional($item)->unidad_medica ?? '' }}" />
                            </div>

                            <div class="row">
                               <x-template-form.template-form-input-required label="Ponderación" type="text"
                                  name="ponderacion" placeholder="PONDERACION"
                                  grid="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" autocomplete=""
                                  value="{{optional($item)->ponderacion ?? '' }}" />

                               <x-template-form.template-form-input-required label="Calificación" type="text"
                                  name="calificacion" placeholder="CALIFICACION"
                                  grid="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" autocomplete=""
                                  value="{{optional($item)->calificacion ?? '' }}" />
                            </div>
