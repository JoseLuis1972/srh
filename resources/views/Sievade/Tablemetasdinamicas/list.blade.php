                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">Metas Individuales</h3>
                            <h5 class="font-weight-normal mb-0">Descripción y Registro de Metas Individuales</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div>
                                ...
                                @if($letterAdminMatch)
                                    <p class="card-description">
                                        ...
                                        <a href="{{ route('Tablemetasdinamicas.create') }}" class="text-danger" style="margin-left: 10px;">
...
<div id="deleteModal" class="modal">
    ...
    <!-- CODE SCRIPT-->
    <script src="{{ asset('assets/js/app/Sievade/Tablemetasdinamicas/table.js') }}"></script>
</x-template-app.app-layout>
