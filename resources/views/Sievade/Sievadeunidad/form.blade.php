                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_tipo_unidad) ? 'Modificar' : 'Agregar ' }}  Tipo de Unidad de Medida"
                            route="{{ route('Sievadeunidad.list') }}" />

                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('Sievadeunidad.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
