                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_alineacion_pnd) ? 'Modificar' : 'Agregar ' }} Aliniacion al PND "
                            route="{{ route('Sievadealineacion.list') }}" />

                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('Sievadealineacion.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
