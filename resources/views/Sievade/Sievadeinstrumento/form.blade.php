                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_int_gest_rend) ? 'Modificar' : 'Agregar ' }} Instrumento de gestion del rendimiento de origen"
                            route="{{ route('Sievadeinstrumento.list') }}" />

                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('Sievadeinstrumento.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
